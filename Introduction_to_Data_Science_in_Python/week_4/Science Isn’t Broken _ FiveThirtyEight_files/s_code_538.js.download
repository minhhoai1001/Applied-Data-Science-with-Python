        ...
        try{
            ...
            switch(autoPlay){
                case false: 
                    ...
                    break;
                case true:
                    if (previousVideo && media.name !== previousVideo) { // Continues playing after a previous video ended
                        s.eVar30 = 'autoadvance';
                    } else {
                        s.eVar30 = 'autostart';
                    }
                    break;
                default:
                    s.eVar30 = 'unspecified';
            }
